...
import '../Styles/UnpaidInvoices.css'
        ...
        <div>
            ...
            <div className="platform1">
                <div id="wrapper" className={isToggled ? 'toggled' : ''}>
                    ...
                    <div className='unpaidinvoice-wrappers'>
                        <div className='unpaidinvoice-section'>
                            <div className="upgradeNow">
                                <h5>Upgrade Now</h5>
                            </div>
                            <div className="unpaidinvoice-search">
                            ...
                            <table className="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td className='' id='apple' scope="row" style={{ fontSize: '14px', textAlign: 'left' }}>Apple</td>
                                    ...
                                    <tr>
                                        <td className='' id='microsoft' scope="row" style={{ fontSize: '14px', textAlign: 'left' }}>Microsoft</td>
                                    ...
                                    <tr>
                                        <td className='' id='magic' scope="row" style={{ fontSize: '14px', textAlign: 'left' }}>Magic</td>
